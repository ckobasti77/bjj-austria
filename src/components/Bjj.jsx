...
const Bjj = ({ scrollToTop }) => {
    ...
    return (
        <section className="py-10 bg-[url(/./img/BTT-bg-light.png)] dark:bg-[url(/./img/BTT-bg.png)] lg:py-24" >
            <div className="mx-auto xl:px-8 w-full" data-aos='fade-left' data-aos-delay='400'>
                ...
                <div className="grid home-buttons grid-cols-1 gap-12 mt-8 lg:grid-cols-2 m-4 lg:mx-16 md:mx-40 md:mt-16 lg:gap-x-12">
                    <Link onClick={() => scrollToTop()} to='/MMA' className='group relative z-[99999999] transition duration-500 hover:scale-105'>
                    ...
                    <Link onClick={() => scrollToTop()} to='/BJJ' className='group relative z-[9999999] transition duration-500 hover:scale-105'>
                        <a href=""><img src="/./img/bjj.jpg" alt="bjj" className=' w-full md:h-96 rounded-md' data-aos='fade-left' data-aos-delay='500' /></a>
                        <span className="group-hover:scale-[1.3] transition duration-[500ms] absolute bottom-6 left-0 right-0 text-xl text-white ">Click to see more</span>
                    </Link>

                    <Link onClick={() => scrollToTop()} to='/Grappling' className='group relative z-[9999999] transition duration-500 hover:scale-105'>
