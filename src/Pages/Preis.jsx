    ...
    <div>
      <section className="py-12 bg-white sm:py-16 lg:py-20 bg-[url(/./img/BTT-bg-light.png)]">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div data-aos='fade-right' data-aos-delay='600' className="max-w-2xl text-center sm:text-left">
          ...
          <div data-aos='fade-right' data-aos-delay='900' className="flex sm:inline-flex px-5 py-4 rounded border border-gray-300 items-center justify-center sm:justify-start space-x-2.5 mt-12">
          ...
          <div className="grid grid-cols-1 px-12 mt-8 text-center sm:text-left sm:px-0 gap-x-12 gap-y-16 lg:mt-16 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div data-aos='fade-left' data-aos-delay='900'>
              ...
              <div className="flex items-end justify-center mt-6 sm:justify-start">
                <p className="text-5xl font-bold text-[#191919] font-pj">150€</p>
                <p className="text-lg font-medium text-gray-400 font-pj">/mo</p>
              </div>
      ...
      <div>
        <div className="bg-[#191919] flex justify-between text-white text-center text-xl py-2">
          <p className="flex justify-around flex-wrap sliding-text w-screen py-1">
            ...
            <span className="flex items-center">
              <span className="mx-1">
                <BsMailbox2 className="fill-[#FE0000]" />
              </span>
