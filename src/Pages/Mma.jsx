        ...
        <div className="flex flex-col-reverse lg:flex-row gap-y-8 min-h-[700px] w-full mx-auto">
          ...
          <div data-aos='fade-left' data-aos-delay='700' className="text-white md:text-justify p-4 w-full lg:w-3/6">
            ...
            <p className="text-lg md:text-xl px-8 lg:px-16 xl:px-24 2xl:px-32">
              ...
              Vollkontakt-Kampfsport, der auf Schlagen, Grappling und Bodenkampf
              basiert und Techniken beinhaltet aus verschiedenen Kampfsportarten
              aus der ganzen Welt. Die erste dokumentierte Verwendung des
              Begriffs Mixed Martial Arts erfolgte 1993 in einer Rezension von
              UFC 1 durch den Fernsehkritiker Howard Rosenberg. Die Frage, wer
              den Begriff tatsächlich geprägt hat, ist umstritten.
            </p>
          </div>
        </div>
          ...
          <div data-aos='fade-right' data-aos-delay='700' className="text-white p-4 w-full lg:w-3/6 flex flex-col justify-center">
            ...
            <ul className="list-disc text-lg md:text-xl px-8 lg:px-16 xl:px-24 2xl:px-32">
              ...
              <p className="md:text-lg pl-4 pt-2">
                Wenn Sie Vertrauen in Ihre defensiven Fähigkeiten haben, ist es
                viel einfacher, ein Risiko einzugehen und anzugreifen, da Sie
                wissen, dass Sie die Fähigkeiten haben, um herauszukommen, wenn
                Sie in einer Unterwerfung oder einer schlechten Position landen.
              </p>
              <li className="pt-4">
                Jiu-Jitsu hilft Ihnen, die Distanz zu kontrollieren
              </li>
              <p className="md:text-lg pl-4 pt-2">
                Es ist von unschätzbarem Wert zu wissen, wie man die Frames und
                die Nähe eines Gegners aufschlüsselt.
              </p>
              <li className="pt-4">Jiu-Jitsu ermöglicht es Ihnen, den Kampf zu beenden</li>
              <p className="md:text-lg pl-4 pt-2">
                Eine großartige Verteidigung zu haben, zu wissen, wie man die
                Distanz kontrolliert und Kämpfe beenden kann, sind drei wichtige
                Gründe, warum Jiu-Jitsu eine wesentliche Fähigkeit für gemischte
                Kampfkünste ist.
              </p>
            </ul>
          </div>
